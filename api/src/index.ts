...
const baseProducts = [
    ...
    {
        id: 5, name: 'Vertical Striped Shirt', description: faker.lorem.paragraph(), image_url: ['https://live.staticflickr.com/65535/53649529079_e5f0a81207_m.jpg'], marca: "Zara", style: "formal", color: ["blue", "red", "black"], size: ["small", "medium", "large", "x-large"], clothing: "Shirt", quality: 5.0, price: 21200
    },
    {
        id: 6, name: 'Courage Graphic T-shirt', description: faker.lorem.paragraph(), image_url: ['https://live.staticflickr.com/65535/53649644700_162d702cd2_m.jpg'], marca: "Zara", style: "formal", color: ["blue", "red", "black"], size: ["small", "medium", "large", "x-large"], clothing: "T-shirt", quality: 4.0, price: 14500
    },
    {
        id: 7, name: 'Loose FituseContext Bermuda Shorts', description: faker.lorem.paragraph(), image_url: ['https://live.staticflickr.com/65535/53649647615_677753d70b_m.jpg'], marca: "Zara", style: "gym", color: ["blue", "red", "black"], size: ["small", "medium", "large", "x-large"], clothing: "Shorts", quality: 3.0, price: 8000
    },
    {
        id: 8, name: 'Faded Skinny Jeans', description: faker.lorem.paragraph(), image_url: ['https://live.staticflickr.com/65535/53649183521_a0bfd9b2bb_m.jpg'], marca: "Zara", style: "gym", color: ["blue", "red", "black"], size: ["small", "medium", "large", "x-large"], clothing: "Jeans", quality: 4.5, price: 21000
    },
    {
        id: 9, name: 'Polo with Contrast Trims', description: faker.lorem.paragraph(), image_url: ['https://live.staticflickr.com/65535/53649644655_61d4cde20d_m.jpg'], marca: "Zara", style: "party", color: ["pink", "blue", "yellow"], size: ["small", "medium", "large", "x-large"], clothing: "Shirt", quality: 4.0, price: 21200
    },
    {
...
const typeDefs = `#graphql
  ...
  type Query {
    products(style: String, color: String, size: String, clothing: String): [Product]
...
const resolvers = {
    Query: {
        products: (parent, { style, color, size, clothing }) => {
            ...
            if (clothing) {
                filteredProducts = filteredProducts.filter(product => product.clothing === clothing);
            }
